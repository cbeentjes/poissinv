% poissinv_fast.m Help file for poissinv_fast MEX-file.
%  poissinv_fast.c - Fast evaluation of the Poisson inverse cumulative 
%  distribution function.
%
%   X = poissinv_fast(P,LAMBDA) returns the inverse of the Poisson cdf 
