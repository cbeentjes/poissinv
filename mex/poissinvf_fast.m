% poissinvf_fast.m Help file for poissinv_fast MEX-file.
%  poissinvf_fast.c - Fast evaluation of the Poisson inverse cumulative 
%  distribution function in single precision.
%
%   X = poissinvf_fast(P,LAMBDA) returns the inverse of the Poisson cdf 
%   with parameter lambda. Since the Poisson distribution is discrete,
%   poissinv_fast returns the smallest value of X, such that the Poisson 
