% poisscinvf_fast.m Help file for poissinv_fast MEX-file.
%  poissinvf_fast.c - Fast evaluation of the Poisson inverse complementary
%  cumulative distribution function in single precision.
%
%   X = poisscinvf_fast(P,LAMBDA) returns the inverse of the Poisson 
%   complementary cdf with parameter lambda. Since the Poisson distribution
%   is discrete, poisscinvf_fast returns the smallest value of X, such that 
